...
function Metrics(queue) {
  ...
  if (this._queue.length) {
    this._queue.forEach((function(call) {
      return $__0[call.method].apply($__0, call.arguments);
    }));
...
Metrics.prototype.track = function() {
  ...
  var event = new Event(eventName, meta, this.identity);
...
module.exports.getInfo = function() {
  var callback = arguments[0] !== (void 0) ? arguments[0] : noop;
  var parser = new UAParser();
